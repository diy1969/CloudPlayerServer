...
class StudyController extends ThinkUnitController {	
	...
	private function setup(){
		...
		$studydata['devicestudy_device'] = $this->device1_id;
		$studydata['devicestudy_time'] = date('Y-m-d h:i:s');
		$studydata['devicestudy_code'] = 1;
		$this->devicestudy1_id = $this->zlt_devicestudy->data($studydata)->add();
	}
	...
	private function teardown(){
		...
		$this->zlt_devicestudy->where("devicestudy_id=$this->devicestudy1_id")->delete();
		
		$this->zlt_devicestudy->where("devicestudy_device=$this->device1_id")->delete();
	}
	...
	function __construct(){
		...
		$this->zlt_devicestudy= M('zlt_devicestudy');
	}
	...
	function test_index(){
		...
		$url = "http://app.imerit.cn:8000/test/tp/index.php?s=home/study/index".
